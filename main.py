...
if __name__ == "__main__":
	...
	# create host arrays
	h_a = numpy.array([numpy.uint8(0b10100011), numpy.uint8(0b10100011)])
	h_b = numpy.array([numpy.uint8(0b00111010), numpy.uint8(0b00111010)])
	...
	multip.set_scalar_arg_dtypes([None, None, None])
	multip(queue, h_a.shape, None, d_a, d_b, d_c)
